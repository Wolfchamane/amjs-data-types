...
module.exports = {
    ...
    AmjsDataTypesBase: AmjsDataTypesBase,
    AmjsDataTypesBoolean: AmjsDataTypesBoolean,
    AmjsDataTypesCollection: AmjsDataTypesCollection,
    AmjsDataTypesDate: AmjsDataTypesDate,
    AmjsDataTypesMoney: AmjsDataTypesMoney,
    AmjsDataTypesNumber: AmjsDataTypesNumber,
    AmjsDataTypesObject: AmjsDataTypesObject,
    AmjsDataTypesPassword: AmjsDataTypesPassword,
    AmjsDataTypesString: AmjsDataTypesString
};
